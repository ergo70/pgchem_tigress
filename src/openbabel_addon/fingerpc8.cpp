...
class PatternCountFP  : public OBFingerprint
{
private:
...
//PatternCountFP thePatternFP("FP3");

PatternCountFP evoPatternFP("FPPC8", "dictionary.txt");
//***********************************************

/*! \class PatternCountFP
...
\code
PatternCountFP myPatternFP("myFP", "myPatternFile.txt");
\endcode
*/
